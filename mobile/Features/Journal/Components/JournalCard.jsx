import {
  ...
  export default function JournalCard(props) {
    const handlePress = (text) => {
        props.onPress(text);
    } //calls the onPress function from props, which is a function in JournalHistoryPage to navigate to the past journal entry with the previously written text
    return (
    ...
    ); //Journal Card only shows username, date, and prompt; you see the body/text when you click on the card and it takes you to the past journal entry page
  }
